...
namespace UnityEngine.Rendering.PostProcessing
{
    ...
    public sealed class MultiScaleVO : IAmbientOcclusionMethod
    {
        ...
        void PushUpsampleCommands(CommandBuffer cmd, int lowResDepth, int interleavedAO, int highResDepth, int? highResAO, RenderTargetIdentifier dest, Vector3 lowResDepthMax, Vector2 highResDepthMax, bool invert = false)
        {
            ...
            float stepSize = 1920f / lowResDepthMax.x;
            ...
            cmd.SetComputeVectorParam(cs, "InvLowResolution", new Vector2(1f / lowResDepthMax.x, 1f / lowResDepthMax.y));
            cmd.SetComputeVectorParam(cs, "InvHighResolution", new Vector2(1f / highResDepthMax.x, 1f / highResDepthMax.y));
            ...
            int xcount = ((int)highResDepthMax.x + 17) / 16;
            int ycount = ((int)highResDepthMax.y + 17) / 16;
